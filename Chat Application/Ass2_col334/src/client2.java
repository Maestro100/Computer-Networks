...
class TCPClient2 {
  ...
  public static void main(String argv[]) throws Exception {
    ...
    Socket receiverSocket = new Socket("localhost", 6003);
    Socket senderSocket = new Socket("localhost", 7003);
  ...
  public static boolean recieverTamperCheck(String pubKeyA, String pvtKeyB, String hDash64, String mDash64)
    ...
    // A->B
    return Arrays.equals(getHash(Base64.getDecoder().decode(mDash64)),
        decryptUsingPublic(Base64.getDecoder().decode(pubKeyA), Base64.getDecoder().decode(hDash64)));
  }
